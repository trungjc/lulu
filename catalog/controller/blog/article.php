...
class ControllerBlogArticle extends Controller {
	...
	public function index() {  
		...
		if ($news_info) {
			...
			$this->document->addLink($this->url->link('blog/article', 'news_id=' . $this->request->get['news_id']), 'canonical');
			
			$this->data['breadcrumbs'][] = array(
				'text'      => $news_info['title'],
				'href'      => $this->url->link('blog/article', $npath_url . 'news_id=' . $this->request->get['news_id']),
				'separator' => $this->language->get('text_separator')
			);		
	...
	public function comment()
	{
		...
		$pagination->url = $this->url->link('blog/news/comment', 'news_id=' . $news_id . '&page={page}#comment_area');
