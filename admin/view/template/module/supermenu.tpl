  ...
  <div class="box">
	...
	<?php $this->load->model('tool/image'); ?>
	  ...
	  <div id="tab-items">
		...
		<?php echo $text_settings_isresponsive; ?>
		<?php if ($supermenu_supermenuisresponsive) { ?>
                <input type="radio" name="supermenu_supermenuisresponsive" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="supermenu_supermenuisresponsive" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="supermenu_supermenuisresponsive" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="supermenu_supermenuisresponsive" value="0" checked="checked" />
                <?php echo $text_no; ?>
        <?php } ?>
		</div>
		<div class="settings-row">
		...
		<div class="settings-row">
	     ...
	     <input type="text" name="supermenu_settings[expbm]" class="colors" value="<?php echo isset($settings['expbm']) ? $settings['expbm'] : ''; ?>" size="7" /> or if expanded
		 <input type="text" name="supermenu_settings[expbme]" class="colors" value="<?php echo isset($settings['expbme']) ? $settings['expbme'] : ''; ?>" size="7" />
	    </div>
		<div class="settings-row">
		Mobile menu override (all links color):
	     <input type="text" name="supermenu_settings[mmol]" class="colors" value="<?php echo isset($settings['mmol']) ? $settings['mmol'] : ''; ?>" size="7" />
	    </div>
		<div class="settings-row">
		Mobile menu override (dropdown background):
	     <input type="text" name="supermenu_settings[mmod]" class="colors" value="<?php echo isset($settings['mmod']) ? $settings['mmod'] : ''; ?>" size="7" />
	    </div>
		<div class="settings-row">
		Mobile menu override (item border color):
	     <input type="text" name="supermenu_settings[mmobc]" class="colors" value="<?php echo isset($settings['mmobc']) ? $settings['mmobc'] : ''; ?>" size="7" />
	    </div>
		</td>
		</tr>
		</table>
