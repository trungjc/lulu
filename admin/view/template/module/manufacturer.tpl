      ...
      <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="right"><input type="text" name="manufacturer_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
    ...
    html += '    </select></td>';
	html += '    <td class="right"><input type="text" name="manufacturer_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
