          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'r.name') { ?>
              ...
              <td class="left"><?php if ($sort == 'r.email') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'r.comment') { ?>
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($comment['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $comment['news_comment_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $comment['news_comment_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $comment['news_title']; ?></td>
              <td class="left"><?php echo $comment['name']; ?></td>
              <td class="left"><?php echo $comment['email']; ?></td>
...
function filter() {
	url = 'index.php?route=news/comment&token=<?php echo $token; ?>';
