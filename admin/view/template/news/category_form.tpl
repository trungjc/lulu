  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs">
		...
		<a href="#tab-permission"><?php echo $tab_permission; ?></a>
	  </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><textarea name="news_category_description[<?php echo $language['language_id']; ?>][meta_description]" cols="40" rows="5"><?php echo isset($news_category_description[$language['language_id']]) ? $news_category_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><textarea name="news_category_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="40" rows="5"><?php echo isset($news_category_description[$language['language_id']]) ? $news_category_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
        ...
        <div id="tab-permission">
          <table class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $entry_customer_group; ?></td>
                <td class="right"><?php echo $entry_read_permission; ?></td>
              </tr>
            </thead>
            ...
            <tbody>
              <tr>
                ...
                <td class="right">
				<?php if (isset($read_permission[$customer_group['customer_group_id']]) && $read_permission[$customer_group['customer_group_id']]) { ?>
                <input type="checkbox" name="read_permission[<?php echo $customer_group['customer_group_id']; ?>]" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="read_permission[<?php echo $customer_group['customer_group_id']; ?>]" value="1" />
                <?php } ?>
				</td>
              </tr>
            </tbody>
