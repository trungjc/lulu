...
<div class="box">    
	...
	<?php if(!empty($check_news_id)){ ?>
		<div><input type="checkbox" name="ignore_date_modified" value="1"> <?php echo $text_ignore_date_modified; ?></div><br />
	<?php } ?>
				...
				<div id="language<?php echo $language['language_id']; ?>">
					<table class="form">
						<tr>
							...
							<td>
								<input name="news_description[<?php echo $language['language_id']; ?>][title]" size="100" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['title'] : ''; ?>" />
						...
						<tr>
							...
							<td>
								<textarea name="news_description[<?php echo $language['language_id']; ?>][short_description]" cols="80" rows="5"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['short_description'] : ''; ?></textarea>
						...
						<tr>
							...
							<td>
								<textarea name="news_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['description'] : ''; ?></textarea>
						...
						<tr>
							...
							<td>
								<textarea name="news_description[<?php echo $language['language_id']; ?>][meta_description]" cols="80" rows="3"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
							</td>
						</tr>   
						<tr>
							<td><?php echo $entry_meta_keyword; ?></td>
							<td>
								<textarea name="news_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="80" rows="3"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
							</td>
						</tr>
						<tr>
							<td><?php echo $entry_tag; ?></td>
							<td>
								<input type="text" name="news_tag[<?php echo $language['language_id']; ?>]" size="80" value="<?php echo isset($news_tag[$language['language_id']]) ? $news_tag[$language['language_id']] : ''; ?>" />
							</td>
						</tr>
					</table>
				</div>
        ...
        <tr>
          ...
          <tr>
            <td><?php echo $entry_comment_permission; ?></td>
            <td><select name="comment_permission">
          ...
          <tr>
            <td><?php echo $entry_comment_need_approval; ?></td>
            <td><select name="comment_need_approval">
