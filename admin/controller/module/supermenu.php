...
class ControllerModulesupermenu extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['supermenu_supermenuisresponsive'])) {
			...
			$this->data['supermenu_supermenuisresponsive'] = $this->config->get('supermenu_supermenuisresponsive');
		} else {
		...
		if (isset($this->request->post['supermenu_more2'])) {
			...
			$this->data['supermenu_more2'] = $this->config->get('supermenu_more2');
		} else {
		...
		if (isset($this->request->post['supermenu_more2_title'])) {
			...
			$this->data['supermenu_more2_title'] = $this->config->get('supermenu_more2_title');
		}
		...
		if (isset($this->request->post['supermenu_dropdowntitle'])) {
			...
			$this->data['supermenu_dropdowntitle'] = $this->config->get('supermenu_dropdowntitle');
		} else {
		...
		if (isset($this->request->post['supermenu_topitemlink'])) {
			...
			$this->data['supermenu_topitemlink'] = $this->config->get('supermenu_topitemlink');
		} else {
		...
		if (isset($this->request->post['supermenu_skin'])) {
			...
			$this->data['supermenu_skin'] = $this->config->get('supermenu_skin');
		} else {
		...
		if (isset($this->request->post['supermenu_flyout_width'])) {
			...
			$this->data['supermenu_flyout_width'] = $this->config->get('supermenu_flyout_width');
		} else {
		...
		if (isset($this->request->post['supermenu_mobilemenuname'])) {
			...
			$this->data['supermenu_mobilemenuname'] = $this->config->get('supermenu_mobilemenuname');
		} else {
		...
		if (isset($this->request->post['supermenu_infodname'])) {
			...
			$this->data['supermenu_infodname'] = $this->config->get('supermenu_infodname');
		} else {
		...
		if (isset($this->request->post['supermenu_brandsdname'])) {
			...
			$this->data['supermenu_brandsdname'] = $this->config->get('supermenu_brandsdname');
		} else {
		...
		if (isset($this->request->post['supermenu_latestpname'])) {
			...
			$this->data['supermenu_latestpname'] = $this->config->get('supermenu_latestpname');
		} else {
		...
		if (isset($this->request->post['supermenu_specialpname'])) {
			...
			$this->data['supermenu_specialpname'] = $this->config->get('supermenu_specialpname');
		} else {
		...
		if (isset($this->request->post['supermenu_featuredpname'])) {
			...
			$this->data['supermenu_featuredpname'] = $this->config->get('supermenu_featuredpname');
		} else {
		...
		if (isset($this->request->post['supermenu_bestpname'])) {
			...
			$this->data['supermenu_bestpname'] = $this->config->get('supermenu_bestpname');
		} else {
		...
		if (isset($this->request->post['supermenu_3dlevellimit'])) {
			...
			$this->data['supermenu_3dlevellimit'] = $this->config->get('supermenu_3dlevellimit');
		} else {
		...
		if (isset($this->request->post['supermenu_viewallname'])) {
			...
			$this->data['supermenu_viewallname'] = $this->config->get('supermenu_viewallname');
		} else {
		...
		if (isset($this->request->post['supermenu_viewmorename'])) {
			...
			$this->data['supermenu_viewmorename'] = $this->config->get('supermenu_viewmorename');
		} else {
		...
		if (isset($this->request->post['supermenu_dropdowneffect'])) {
			...
			$this->data['supermenu_dropdowneffect'] = $this->config->get('supermenu_dropdowneffect');
		} else {
		...
		if (isset($this->request->post['supermenu_usehoverintent'])) {
			...
			$this->data['supermenu_usehoverintent'] = $this->config->get('supermenu_usehoverintent');
		} else {
		...
		if (isset($this->request->post['supermenu_tophomelink'])) {
			...
			$this->data['supermenu_tophomelink'] = $this->config->get('supermenu_tophomelink');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea1'])) {
			...
			$this->data['supermenu_htmlarea1'] = $this->config->get('supermenu_htmlarea1');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea2'])) {
			...
			$this->data['supermenu_htmlarea2'] = $this->config->get('supermenu_htmlarea2');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea3'])) {
			...
			$this->data['supermenu_htmlarea3'] = $this->config->get('supermenu_htmlarea3');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea4'])) {
			...
			$this->data['supermenu_htmlarea4'] = $this->config->get('supermenu_htmlarea4');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea5'])) {
			...
			$this->data['supermenu_htmlarea5'] = $this->config->get('supermenu_htmlarea5');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea6'])) {
			...
			$this->data['supermenu_htmlarea6'] = $this->config->get('supermenu_htmlarea6');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea7'])) {
			...
			$this->data['supermenu_htmlarea7'] = $this->config->get('supermenu_htmlarea7');
		} else {
		...
		if (isset($this->request->post['supermenu_htmlarea8'])) {
			...
			$this->data['supermenu_htmlarea8'] = $this->config->get('supermenu_htmlarea8');
		} else {
		...
		if (isset($this->request->post['supermenu_bannerspace_width'])) {
			...
			$this->data['supermenu_bannerspace_width'] = $this->config->get('supermenu_bannerspace_width');
		} else {
